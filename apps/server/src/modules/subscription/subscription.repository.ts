...
export class SubscriptionRepository {
  ...
  async findSubscriptionPlanById(id: string): Promise<subscription_plans | null> {
    return this.prisma.subscription_plans.findFirst({
      where: { id, is_active: true },
    });
  }

  async findPlanByStripePrice(priceId: string): Promise<subscription_plans | null> {
    return this.prisma.subscription_plans.findFirst({
      where: { stripe_price_id: priceId, is_active: true },
    });
  }

  async findUserByStripeCustomerId(customerId: string): Promise<user_subscriptions | null> {
  ...
  async upsertUserSubscription(
    ...
    createData: UpsertUserSubscriptionData,
    updateData: UpdateUserSubscriptionData,
  ...
  async findActiveSubscriptionByStripeIds(customerId: string, subscriptionId: string) {
    return this.prisma.user_subscriptions.findFirst({
      where: {
  ...
  async updateSubscriptionById(id: string, data: UpdateUserSubscriptionData): Promise<user_subscriptions> {
  ...
  async createUserSubscription(data: CreateUserSubscriptionData): Promise<user_subscriptions> {
    return this.prisma.user_subscriptions.create({ data });
  }

  async findSubscriptionByStripeIds(customerId: string, subscriptionId: string) {
    return this.prisma.user_subscriptions.findFirst({
      where: {
        stripe_customer_id: customerId,
        stripe_subscription_id: subscriptionId,

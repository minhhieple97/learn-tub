...
type IUseRichTextEditorReturn = {
  ...
  // Form state properties  formTags: string[];
  tagInput: string;
  editingNote: any;
...
export const useRichTextEditor = (): IUseRichTextEditorReturn => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `${RICH_TEXT_EDITOR.PROSE_CLASSES} prose-img:max-w-xs prose-img:h-auto prose-img:rounded-lg prose-img:shadow-sm prose-img:my-4`,
      },

import { createSearchParamsCache, parseAsStringLiteral, parseAsString } from 'nuqs/server';
...
export const learnPageParsers = {
  tab: parseAsStringLiteral(Object.values(tabValues)).withDefault(tabValues.add),
  q: parseAsString,
};

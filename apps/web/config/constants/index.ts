...
export const TRANSACTION_TYPES = createEnumConstants(
  Constants.public.Enums.transaction_type_enum,
);
...
export const CREDIT_ACTION_COUNTS = {
  [AI_COMMANDS.EVALUATE_NOTE as string]: 1,
  [AI_COMMANDS.GENERATE_QUIZZ_QUESTIONS as string]: 1,
  [AI_COMMANDS.EVALUATE_QUIZZ_ANSWERS as string]: 1,
} as const;

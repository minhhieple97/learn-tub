...
export const NoteEvaluation = ({ noteId, disabled }: NoteEvaluationProps) => {
                    ...
                    <div className="text-center space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
                          Analyze your learning notes with advanced AI to
                          receive personalized feedback on accuracy, clarity,

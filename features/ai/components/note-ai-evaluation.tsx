...
import { Brain, Settings, AlertTriangle, Sparkles, ArrowRight, History } from 'lucide-react';
                    ...
                    <div className="text-center space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
                          Analyze your learning notes with advanced AI to receive personalized
                          feedback on accuracy, clarity, and suggestions for improvement.
                        </p>
                      </div>

...
import { createAIInteraction } from '@/features/ai/queries';
import { aiEvaluationService } from '@/features/ai/services';
import {
  AI_PROVIDERS,
  AI_HTTP_STATUS,
  AI_ERROR_MESSAGES,
      ...
      async start(controller) {
        ...
        try {
          ...
          const errorChunk: AIStreamChunk = {
            ...
            content: error instanceof Error ? error.message : AI_ERROR_MESSAGES.UNKNOWN_ERROR,
            finished: true,
          };

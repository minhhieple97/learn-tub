    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <YouTubePlayer videoId={videoId} onTimeUpdate={handleTimeUpdate} />
          <Card className="mt-4">
            <CardHeader>
            ...
            <CardContent>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                ...
                <p>
                  Published:{" "}
                  {video.published_at ? new Date(video.published_at).toLocaleDateString() : "Publication date unknown"}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="lg:col-span-1">
          <Tabs defaultValue="notes">
            ...
            <TabsContent value="notes" className="mt-4">
              <NoteEditor videoId={videoId} currentTimestamp={currentTimestamp} />
            </TabsContent>
